package com.campus.trade.review.util;

import com.campus.trade.review.exception.AuthenticationException;
...
public class LoginUserHelper {
    ...
    public String getCurrentUserId(HttpServletRequest request) {
        return getCurrentUserId(request.getHeader("Authorization"));
    }
